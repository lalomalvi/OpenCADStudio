...
CROP = (1125, 340, 1260, 390)
SCALE = 8
EXPECTED = ((1155, 365), (1239, 365))
TOLERANCE = 5
PROMPT = (
    "Observa este recorte 8x de una ventana horizontal en un muro superior de planta. "
    "Marca los dos remates izquierdo y derecho donde la banda gris sólida del muro se "
    "interrumpe por el marco de la ventana. Da el centro vertical aproximado de la banda "
    "en ambos remates. Usa coordenadas enteras [x,y] del recorte de 1080x400 píxeles, "
    "de izquierda a derecha. No sigas la línea de cota, el eje punteado ni el patrón "
    "del piso. Responde SOLO JSON estricto con schema_version='ocs-window-endpoints-1', "
    "status='observed', left_px, right_px, confidence. Si no ves claramente ambos "
...
def prepare(source, root):
    ...
    freeze = {"schema_version": "m7-east-north-window-observation-freeze-1",
...
def score(source, root, *, persist=True):
    ...
    outcome = {"schema_version": "m7-east-north-window-observation-verdict-1",
