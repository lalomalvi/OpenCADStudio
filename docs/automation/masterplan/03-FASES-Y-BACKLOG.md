...
| M5.3 cotas lineal/alineada | partial L2 | DIMLINEAR 2.50 y DIMALIGNED 5.00 persistieron. Otra DIMLINEAR pasó de 2.50 a 3.50 al editar por contrato tipado el extremo de su línea y conservó 3.50 tras reapertura interna. Persistencia del vínculo ante segunda edición, QA completa y motor externo pendientes |
...
| M5.5 HATCH | partial L2 | HATCH nativo desde punto interno de PLINE cerrada; una ruta de contorno, capa A-HATCH, patrón/escala/ángulo y flag asociativo conservados tras reapertura interna. Actualización del contorno, legibilidad por escala y motor externo pendientes |
