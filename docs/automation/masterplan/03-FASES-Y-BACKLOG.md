...
| M3.1, M3.2, M3.3, M3.5, M3.6 | partial L1/L2 | 84 respuestas únicas reproducen 9,797,952 tokens históricos sin exportar rollout; PNG sintético 1024×506 con documento/revisiones y hash, trace RPC sanitizado, AUDIT/SAVE/VERDICT/ARTIFACTS/SEAL v2 verificados. Checkpoint de comandos con presupuesto pasos/tiempo sobrevivió reinicio del cliente MCP. Sin render-fence explícito, cuotas tokens/capturas/bytes ni tiempos CAD por fase |
