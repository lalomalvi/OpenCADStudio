...
| M4 muros/aperturas v3 | partial L0 | PlanSpec v3 versiona muros rectos por nodos, espesor, capa y procedencia; aperturas por muro, offset, ancho, tipo y procedencia. Valida referencias, límites, grosor y solapes. El dry-run del fixture de 4 m/puerta 0.9 m declara `wall_compilation` y `opening_compilation` unsupported y no permite CAD. Faltan geometría nativa, uniones, giro/bisagra, ventanas por altura y vínculos a cotas |
