...
| M3.1, M3.2, M3.3, M3.5 | partial L1/L2 | 84 respuestas únicas reproducen 9,797,952 tokens históricos sin exportar rollout; referencias de PNG, trace RPC sanitizado y AUDIT/SAVE/VERDICT/SEAL generados del run L2 sintético, verificados por hash. Sin render-fence/imagen real ni tiempos CAD por fase |
