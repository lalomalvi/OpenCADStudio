...
| M4 unión explícita v5 | partial L0 | PlanSpec v5 añade `joins` con ID, dos muros/extremos dirigidos y `style=orthogonal_union`. Rechaza referencias inexistentes, extremos no coincidentes, ejes no perpendiculares, espesores distintos y reutilización de un extremo. Fixture L con dos muros es `validated_uncompiled`, `executable=false`, sin CAD invocado. Falta unión geométrica, mapa de partes/handles y L2/L4 |
