...
| M6.3 barrido de puerta | partial L0 | `door_clearance_qa` v2 usa bisagra/lado/ancho explícitos de v4–v7 para detectar cruces interiores de la hoja abierta y penetración del sector barrido de 90° por líneas fuente; excluye contactos solo tangentes o de extremo. Un cruce del sector con línea de contorno bloquea `executable`; una línea sin clase queda en revisión. Fixture base claro; pruebas cubren cruce de hoja, línea interior que evita la hoja, tangencia exterior y cruce de contorno. Faltan obstáculos tipados, volumen 3D, símbolos múltiples y L2/L4 de casos colisionados |
