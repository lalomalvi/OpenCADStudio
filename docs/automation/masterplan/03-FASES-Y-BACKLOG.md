...
| M4 muros/aperturas v3 | partial L0/L2/L4 | PlanSpec v3 versiona muros rectos por nodos, espesor, capa y procedencia; aperturas por muro, offset, ancho, tipo y procedencia. Valida referencias, límites, grosor y solapes. Un muro único sin huecos compila a cuatro LINE con IDs de parte y fuente; L2 preservó 4 handles, DWG y salida limpia; AutoCAD cotejó 4/4 bordes frente al eje/espesor del fixture con INSUNITS=6. Muros múltiples/uniones y cualquier apertura siguen unsupported; el fixture de puerta permanece `executable=false`. Faltan puerta con bisagra/giro, ventanas por altura y vínculos a cotas |
