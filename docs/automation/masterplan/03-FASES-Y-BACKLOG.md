...
| M6.3 cruce de hoja abierta | partial L0 | `door_clearance_qa` usa bisagra/lado/ancho explícitos de v4–v7 para detectar cruces interiores estrictos entre la hoja en posición abierta y líneas fuente. Un cruce con línea de contorno bloquea `executable`; una línea sin clase queda en revisión. Fixture base permanece claro; pruebas cubren ambas categorías. No analiza barrido del arco, contactos en extremos, volumen 3D, muebles tipados ni múltiples símbolos CAD; sin L2/L4 para los casos colisionados |
