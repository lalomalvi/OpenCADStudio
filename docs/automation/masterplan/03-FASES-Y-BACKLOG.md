...
| M6.3 barrido y obstáculos tipados | partial L0 | `door_clearance_qa` v3 conserva cruce de hoja y sector 90° para LINE fuente. PlanSpec v8 exige altura de hoja y obstáculos rectangulares con tipo, huella XY, base/altura z y procedencia. Mobiliario/partición que invade el volumen bloquea `executable`; procedencia inferida se distingue como `review_blocked`; anotación no física y objeto por encima de la hoja no bloquean. Fixture sintético bloqueado y negativos de altura/tipo/área pasaron L0. Faltan mallas/curvas, espesor de hoja, múltiples puertas compiladas y L2/L4 de casos colisionados |
