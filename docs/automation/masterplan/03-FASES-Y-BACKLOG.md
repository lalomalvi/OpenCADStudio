...
| M5.3 cotas lineal/alineada | partial L2 | DIMLINEAR 2.50 y DIMALIGNED 5.00 en A-DIMS antes/después de guardado y reapertura interna; bloques gráficos anónimos materializados comparados estrictamente. Asociatividad al mover referencia, QA completa de geometría y motor externo pendientes |
