...
| M4/M5 cota PlanSpec v7 de espesor | partial scoped L2/L4 | V7 preserva v6 y exige estilo métrico local con nombre reservado, altura de texto/flecha/separación, escala/factor1, y colocación/capa por cota. Solo un muro horizontal sin hueco/unión ni geometría extra, cota face izquierda→derecha exactamente en punto medio, compila cuatro LINE de contorno y una DIMLINEAR; otros casos siguen `native_dimension` unsupported. L2 guardó/reabrió y editó una cara: 0.20→0.25 m. AutoCAD L4-11 verificó en ambos DWG medida, dos refs MID a handles de cara y seis propiedades de estilo, AUDIT 0/0, unidad6 y hash intacto. Negativo de altura de texto fue rechazado. Falta QA visual de la cota, otros ejes/orientaciones y edición externa controlada |
