...
| M5.3 cota lineal | partial L2 | DIMLINEAR nativa midió 2.50 en A-DIMS antes/después de guardado y reapertura interna; bloque gráfico anónimo materializado comparado estrictamente. Asociatividad al mover referencia, DIMALIGNED y motor externo pendientes |
