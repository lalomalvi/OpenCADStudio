"""Independently compare a PlanSpec v10 apartment door by DWG handle."""
...
from apartment_door_trial_v10 import validate_bundle
...
def assess(run: Path, image: Path, binary: Path, external_path: Path) -> dict:
    ...
    if (report.get("schema_version") != "m7-apartment-door-trial-2" or
            report.get("status") != "passed_scoped_typed_door_l2" or
    ...
    return {"schema_version": "m7-apartment-door-l4-2",
