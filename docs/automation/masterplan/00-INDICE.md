...
El recibo L0 de identidad/uso tomado de objetos Responses API se documenta en [M3-DIRECT-RESPONSE-RECEIPT-V1.md](M3-DIRECT-RESPONSE-RECEIPT-V1.md), la creación única de Luna en [M3-LUNA-ONCE-ADAPTER-V1.md](M3-LUNA-ONCE-ADAPTER-V1.md), el gate de salida PlanSpec en [M3-LUNA-PLANSPEC-GATE-V1.md](M3-LUNA-PLANSPEC-GATE-V1.md), el callback reservado en [M3-LUNA-PIPELINE-CALLBACK-V1.md](M3-LUNA-PIPELINE-CALLBACK-V1.md), el ejecutor de GUI aislada en [M3-OWNED-CAD-EXECUTOR-V1.md](M3-OWNED-CAD-EXECUTOR-V1.md), la integración sintética L2 en [M3-RESERVED-PIPELINE-L2-V1.md](M3-RESERVED-PIPELINE-L2-V1.md) y la captura cercada en [M3-FENCED-CAD-CAPTURE-V1.md](M3-FENCED-CAD-CAPTURE-V1.md). Ninguno acredita aún una invocación Luna real.
