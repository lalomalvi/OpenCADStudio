...
def main():
    ...
    if (frozen.get("schema_version") != "m7-apartment-window-trial-freeze-1" or
    ...
    report = {"schema_version": "m7-apartment-window-trial-1", "status": "failed",
    ...
    try:
        ...
        invocation = Invocation("development", root.name, 1,
            "window-v1-" + hashlib.sha256(str(root).encode()).hexdigest()[:24],
