...
from apartment_window_compiler import compose
...
def assess(run, image, binary, external_path):
    ...
    bound = {"source_sha256": _file_sha(image),
             ...
             "runner_sha256": _file_sha(code / "apartment_window_trial.py"),
    ...
    if (external.get("product") != "AutoCAD Core Console" or
            ...
            external.get("model_census_count") != 37 or
            external.get("model_types") != {"LINE": 29, "ARC": 1, "DIMENSION": 7} or
    ...
    return {"schema_version": "m7-apartment-window-l4-1",
            "status": "passed_scoped_l4" if count == 37 else "failed_scoped_l4",
            "acceptance_m7": False, "geometry_matches": count, "geometry_total": 37,
