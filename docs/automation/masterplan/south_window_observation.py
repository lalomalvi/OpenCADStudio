...
CROP = (1125, 840, 1295, 900)
SCALE = 8
EXPECTED = ((1157, 869), (1239, 869))
TOLERANCE = 5
PROMPT = (
    "Observa este recorte 8x de una ventana horizontal en el muro inferior de planta. "
    ...
    "en ambos remates. Usa coordenadas enteras [x,y] del recorte de 1360x480 píxeles, "
    "de izquierda a derecha. No sigas el recuadro blanco, el eje punteado ni el patrón "
...
def prepare(source, root):
    ...
    freeze = {"schema_version": "m7-south-window-observation-freeze-1",
...
def score(source, root, *, persist=True):
    ...
    outcome = {"schema_version": "m7-south-window-observation-verdict-1",
