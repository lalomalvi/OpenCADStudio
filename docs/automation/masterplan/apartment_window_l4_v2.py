...
from apartment_window_compiler_v2 import compose
...
def assess(run, image, binary, external_path):
    ...
    bound = {"source_sha256": _file_sha(image),
             ...
             "runner_sha256": _file_sha(code / "apartment_window_trial_v2.py"),
    ...
    if any(freeze.get(key) != value for key, value in bound.items()):
    ...
    if (report.get("status") != "passed_scoped_window_l2" or
    ...
    return {"schema_version": "m7-apartment-window-l4-2",
