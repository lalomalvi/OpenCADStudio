...
CROP = (440, 345, 570, 385)
SCALE = 8
EXPECTED = ((462, 365), (553, 365))
TOLERANCE = 5
PROMPT = (
    ...
    "en ambos remates. Usa coordenadas enteras [x,y] del recorte de 1040x320 píxeles, "
...
def prepare(source, root):
    ...
    freeze = {"schema_version": "m7-north-window-observation-freeze-1",
...
def score(source, root, *, persist=True):
    ...
    outcome = {"schema_version": "m7-north-window-observation-verdict-1",
