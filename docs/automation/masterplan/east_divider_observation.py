"""One frozen Luna observation of the east bedroom divider wall."""
...
PROMPT = (
    ...
    "coordenadas enteras del recorte, origen arriba a la izquierda. Ignora camas, "
...
def validate(root: Path, source: Path, cli: Path) -> dict:
    ...
    if (freeze.get("schema_version") != "m7-east-divider-observation-freeze-1"
...
def prepare(root: Path, source: Path, cli: Path) -> dict:
    ...
    freeze = {"schema_version": "m7-east-divider-observation-freeze-1",
