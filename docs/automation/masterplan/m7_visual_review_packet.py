"""Overlay a frozen partial PlanSpec on its authorized development image."""
...
PLAN_SHA = "4FC786BB52F9417125A3E012F465A0EF694AA47D3A7EE9632FA5995C6C2A0A4D"
...
def build(source: Path, plan_path: Path, calibration_freeze: Path,
    ...
    if counts != {"structure_lines": 26, "window_lines": 16, "door_lines": 1,
                  "door_arcs": 1, "hidden_reference_lines": 4,
    ...
    labels.text((original_crop.width + 12, 10),
                "SUPERPOSICION: azul estructura, magenta ventanas, naranja puerta",
                fill="black")
    root.mkdir(parents=True)
    combined.save(root / "overlay-full.png")
    comparison.save(root / "review-side-by-side.png")
    result = {"schema_version": "m7-partial-visual-review-packet-1",
